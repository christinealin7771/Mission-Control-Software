...
export default function Graphs() {
  ...
  // ];
  useEffect(() => {
    var map = L.map("map").setView([29.651634, -82.324829], 19);

    L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", {
      attribution:
        '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',
        maxNativeZoom: 19,
        //Making Max 20 instead 
        maxZoom: 20
    }).addTo(map);
  ...
  L.heatLayer(
    [
      [29.651634, -82.324829, 34], //coordinates are the starting view for right now
      [29.651634, -82.324929, 34],
      // [-37.8869090667, 175.3657417333, 20],
      // [-37.8894207167, 175.4015351167, 30],
      // [-37.8927369333, 175.4087452333, 45],
      // [-37.90585105, 175.4453463833, 22],
